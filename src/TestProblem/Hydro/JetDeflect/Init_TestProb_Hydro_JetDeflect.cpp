...
// background parameters
   ...
   LOAD_PARA( load_mode, "Wall_Off",           &Wall_Off,          false,         Useless_bool,   Useless_bool );
   LOAD_PARA( load_mode, "ICM_Blob",           &ICM_Blob,          false,         Useless_bool,   Useless_bool );
   LOAD_PARA( load_mode, "Blob_PosX",          &Blob_PosX,         NoDef_double,  NoMin_double,   NoMax_double );
   LOAD_PARA( load_mode, "Blob_PosY",          &Blob_PosY,         NoDef_double,  NoMin_double,   NoMax_double );
   LOAD_PARA( load_mode, "Blob_Radius",        &Blob_Radius,       NoDef_double,  NoMin_double,   NoMax_double );
   LOAD_PARA( load_mode, "Blob_VelY",          &Blob_VelY,         NoDef_double,  NoMin_double,   NoMax_double );

// jet parameters
   LOAD_PARA( load_mode, "Jet_Fire",           &Jet_Fire,          false,         Useless_bool,   Useless_bool );
   LOAD_PARA( load_mode, "Jet_Axis",           &Jet_Axis,          1,             0,              1            );
